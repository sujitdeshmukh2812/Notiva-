...
app.config["SQLALCHEMY_DATABASE_URI"] = os.environ.get("DATABASE_URL", "sqlite:///studygenie.db")
...
with app.app_context():
    ...
    from models import User, Material, Course, Year, Semester, Subject
    from routes import *
    
    # Create all database tables
    db.create_all()
    
    # Admin user creation moved to create_admin.py script
