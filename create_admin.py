...
def create_admin_account():
    ...
    with app.app_context():
        ...
        try:
            ...
            print("✅ Notiva Admin account created successfully!")
...
def verify_admin_account():
    ...
    with app.app_context():
        ...
        if admin:
            print(f"\n✅ Notiva Admin Account Verification:")
            print(f"ID: {admin.id}")
...
if __name__ == "__main__":
    print("🚀 Notiva Admin Account Creation Script")
    print("=" * 50)
    ...
    if admin:
        ...
        print("\n📝 Next Steps:")
        print("1. Start the Notiva application")
